...
consent privacy-requests term-shifts hardening workplaces general general-tasks general-notify presets general-repo general-files general-drafts general-history general-schedule general-schedule-guard general-spaces general-project-archive general-archive-rbac general-folders general-draft-restore general-project-archive-rbac general-reports general-project-space access one-workplace`.split(/\s+/)
