    ...
    <div className="border-t border-line px-3 py-3 md:px-5 md:py-4">
      ...
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-navy-600 text-white transition-[background-color,scale] duration-200 hover:bg-navy-500 active:scale-95 disabled:opacity-40 dark:bg-navy-500 dark:hover:bg-navy-400"
        >
