      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border border-[var(--line)] bg-[var(--surface)] pr-3 pl-9 text-[14px] text-ink placeholder:text-[var(--ink-faint)] hover:border-[var(--line-strong)] focus:border-navy-400 focus:ring-4 focus:ring-navy-500/12 focus:outline-none"
          />
        </div>
