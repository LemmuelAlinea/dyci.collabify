...
| 5 | Make yourself the admin | [05-admin.md](05-admin.md) | Claude |
...
- Professor accounts held for admin approval
- Role-based app shell for student, professor, and admin
